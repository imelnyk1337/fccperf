...
def run(mainparser, subparser=None):
    ...
    both as `fccanalysis run` and `python config/FCCAnalysisRun_tpl.py`
    ...
    # below is legacy using the old way of runnig with options in "python config/FCCAnalysisRun_tpl.py analysis.py --options
